...
export default {
  data: () => ({
    ...
    searchSettings: [
      ...
      { placeholder: '票务类型', type: 'input' },
      { placeholder: '请输入票务编号及座位号', type: 'input' }
    ],
    searchBtn: [
      { name: '查询', type: 'search' },
      { name: '新增', type: 'add' }
    ...
    dialogs: [
      ...
      { label: '观众票务类型', type: 'input' },
      { label: '观众票务编号', type: 'input' },
      { label: '观众座位号', type: 'input' },
      { label: '观众购票时间', type: 'input' },
