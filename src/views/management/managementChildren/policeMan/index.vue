<template>
  <div class="policeMan">
    ...
    <el-dialog :title="title" :visible.sync="isShow" center width="80%">
...
export default {
  data: () => ({
    ...
    dialogs: [
      ...
      { label: '籍贯', type: 'input' },
      { label: '', type: '' },
      { label: '国家（地区）', type: 'input' },
      { label: '省市县（区）', type: 'input' },
      { label: '', type: '' },
      { label: '区域内详细地址', type: 'input' },
      { label: '实际居住地址', type: 'input' },
      { label: '', type: '' },
      { label: '实际居住地地址编码', type: 'input' },
      { label: '实际居住地省市县（区）', type: 'input' },
      { label: '', type: '' },
      { label: '实际居住地区域内详细地址', type: 'input' },
      { label: '保安证件号码', type: 'input' },
      { label: '', type: '' },
